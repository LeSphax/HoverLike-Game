...
/// the MyTransformView is added to the list of observed components
/// </summary>
[RequireComponent(typeof(PhotonView))]
[AddComponentMenu("Photon Networking/My Transform View")]
public class MyTransformView : MonoBehaviour, IPunObservable
{
    ...
    MyTransformViewPositionControl m_PositionControl;
    ...
    void Awake()
    {
        ...
        m_PositionControl = new MyTransformViewPositionControl();
    ...
    void Update()
    {
        if (m_PhotonView == null || m_PhotonView.isMine == true || PhotonNetwork.connected == false || BallState.IsAttached())
        {
            //Debug.Log(m_PositionControl.GetNetworkPosition() + m_PositionControl.GetExtrapolatedPositionOffset());
            return;
        }
    ...
    {
        m_PositionControl.SetSynchronizedValues(speed * 1.2f, turnSpeed);
    }
