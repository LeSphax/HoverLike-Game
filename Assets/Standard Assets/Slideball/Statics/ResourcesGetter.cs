...
public class ResourcesGetter
{
    ...
    private static GameObject feedbackPanelPrefab;
    public static GameObject FeedbackPanelPrefab
    {
        get
        {
            if (feedbackPanelPrefab == null)
            {
                feedbackPanelPrefab = Resources.Load<GameObject>("Prefabs/FeedbackPanel");
            }
            return feedbackPanelPrefab;
        }
    }
    private static GameObject passwordPanelPrefab;
    public static GameObject PasswordPanelPrefab
    {
        get
        {
            if (passwordPanelPrefab == null)
            {
                passwordPanelPrefab = Resources.Load<GameObject>("Prefabs/PasswordPanel");
            }
            return passwordPanelPrefab;
        }
    }
    ...
    public static void LoadAll()
    {
        ...
        var tempFeedbackPanelPrefab = FeedbackPanelPrefab;
        var tempPasswordPanelPrefab = PasswordPanelPrefab;
