...
var UnityWebRtcNetwork =
{
	...
	UnityWebRtcNetworkConnectToRoom:function(lIndex, lRoom, lPassword)
	{
		return CAPIWebRtcNetworkConnectToRoom(lIndex, Pointer_stringify(lRoom), Pointer_stringify(lPassword));
	},
